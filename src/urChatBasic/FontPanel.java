...
class FontPanel extends JPanel{
	...
	private final String[] FONT_SIZES = { "8", "10", "11", "12", "14", "16", "18","20", "24", "30", "36", "40", "48", "60", "72" };
	...
	private void previewFont(){
		...
		savedFont = new Font(FONT_COMBO_BOX.getSelectedItem().toString(),boldItalic, Integer.parseInt(SIZES_COMBO_BOX.getSelectedItem().toString()));
